"use strict";
(self["webpackChunkguestbook"] = self["webpackChunkguestbook"] || []).push([["/js/counting-num"],{

/***/ "./resources/js/counting-num.js":
/*!**************************************!*\
  !*** ./resources/js/counting-num.js ***!
  \**************************************/
...
/* harmony export */   "check_counting_fun": () => (/* binding */ check_counting_fun),
/* harmony export */   "drawing_graph": () => (/* binding */ drawing_graph),
/* harmony export */   "get_counting_date": () => (/* binding */ get_counting_date)
/* harmony export */ });
...
var check_counting_fun = function check_counting_fun() {
  var date_begin = document.querySelector("#begin");
  var date_end = document.querySelector("#end");
...
var drawing_graph = function drawing_graph(data) {
  var dates = [];
  var message_nums = [];
  var reply_nums = [];
...
var get_counting_date = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(beginning_date, ending_date) {
    var get_counting_data_instance;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            get_counting_data_instance = axios({
              url: "/api/get_counting_num/".concat(beginning_date, "/").concat(ending_date),
              method: 'get',
              headers: {
                "Authorization": "Bearer " + api_token
              }
            });
            get_counting_data_instance.then(function (res) {
  ...
  return function get_counting_date(_x, _x2) {
...
/******/ var __webpack_exports__ = (__webpack_exec__("./resources/js/counting-num.js"));
/******/ }
]);